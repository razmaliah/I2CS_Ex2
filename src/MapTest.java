...
class MapTest {
    ...
    void testDrawCircle() {
        ...
        _m0.drawCircle(center2,radius,11);
        _m0.drawCircle(center,radius,1);
        boolean ans = true;
        for(int i=0;i<11;i++){
            for(int j=0;j<11;j++){
                Pixel2D p = new Index2D(i,j);
                if (p.distance2D(center)<radius && _m0.getPixel(p) !=1){
                    ans = false;
                }
                if (p.distance2D(center)>=radius && _m0.getPixel(p) !=0){
                    ans = false;
                }
            }
        }
    ...
    void testDrawLine2(){
        ...
        Pixel2D p2 = new Index2D(1,9);
        _m0.drawLine(p1,p2,1);
        boolean ans = true;
        for(int i=0;i<10;i++) {
            for(int j=0;j<10;j++) {
                Pixel2D p = new Index2D(i,j);
                if (i==1 && _m0.getPixel(p) !=1){
                    ans = false;
                }
                if (i!=1 && _m0.getPixel(p) !=0){
                    ans = false;
                }
            }
        }
    ...
    void testDrawRect() {
        _m0 = new Map(10);
        Pixel2D botoomLeft = new Index2D(2,2);
        Pixel2D topRight = new Index2D(7,5);
        _m0.drawRect(topRight,botoomLeft,1);
        boolean ans = true;
        for(int w=0;w<10;w++){
            for(int h=0;h<10;h++){
